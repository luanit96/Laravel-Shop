							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$sp->productid)}}"><img src="{{$sp->image}}" alt="{{$sp->productname}}" height="250px"></a>
									</div>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="single-item">
                                    ...
                                    @endif
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$sp_k->productid)}}"><img src="{{$sp_k->image}}" alt="{{$sp_k->productname}}" height="250px"></a>
									</div>
									<div class="single-item-body">
