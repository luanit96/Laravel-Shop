					...
					<div class="your-order">
						...
						<div class="your-order-body" style="padding: 0px 10px">
								...
								<div>
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<p class="font-large">Đơn giá: {{number_format($cart['price'])}} $</p>
											<p class="font-large">Giá khuyến mãi: {{number_format($cart['item']['saleprice'])}} $</p>
										</div>
									</div>
									<!-- end one item -->
									@endforeach
							...
							<div class="your-order-item">
								...
								<div class="pull-right"><h5 class="color-black">@if(Session::has('cart')){{number_format(Session('cart')->total)}}@else 0 @endif $</h5>
								</div>
								<div class="clearfix"></div>
							</div>
						</div>
